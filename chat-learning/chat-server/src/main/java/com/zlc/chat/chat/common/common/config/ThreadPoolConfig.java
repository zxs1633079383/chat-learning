package com.zlc.chat.chat.common.common.config;

import com.zlc.chat.chat.common.common.thread.MyThreadFactory;
...
public class ThreadPoolConfig implements AsyncConfigurer {
     ...
     * 项目共用线程池
     */
    public static final String MALLCHAT_EXECUTOR = "chatExecutor";
    /**
     * websocket通信线程池
     */
